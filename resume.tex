...
% LaTeX Template
% Version 1.3 (28/Aug/2022)
%
% Original author:
% Rajendra Arora (https://www.rajendraarora.com)
%
% Original repository:
% https://github.com/rajendraarora
%
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{Rajendra}{Arora}{ \urlstyle{same}\href{https://rajendraarora.com/}{www.rajendraarora.com} | \href{https://github.com/rajendraarora16}{Github@rajendraarora16}\\
\href{mailto:contact.rajarora@gmail.com}{contact.rajarora@gmail.com} | +66-640235539
}
...
An error tracking tool after Taboola is integrated with publisher website. We track the browser's error from user side and it sends us back for awareness.
\sectionsep
...
Came up with an initiative ideas a to make easier with just by drag/drop to get relevant information of xpath for register in crawler for scraping information.
\sectionsep
